describe('template spec', () => {
  ...
  before(() => {
    ...
    it('กรอกข้อมูลแค่  Policies Name เป็นภาษาไทย', () => {
      ...
      cy.get('input[name="ms_cancellation_fee_policy,policy_name"]').should('have.value','ทดสอบ');
    ...
    it('กรอกข้อมูลแค่  Policies Name เป็นอัครพิเเศษ */-+', () => {
      ...
      cy.get('input[name="ms_cancellation_fee_policy,policy_name"]').should('have.value','+-*/');
